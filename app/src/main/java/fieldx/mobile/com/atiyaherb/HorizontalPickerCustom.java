...
// */
//public class HorizontalPickerCustom extends View {
//
...
//
//    private com.wefika.horizontalpicker.HorizontalPicker.OnItemSelected onItemSelected;
//    private com.wefika.horizontalpicker.HorizontalPicker.OnItemClicked onItemClicked;
//
...
//
//    public HorizontalPickerCustom(Context context) {
//        this(context, null);
//    }
//
//    public HorizontalPickerCustom(Context context, AttributeSet attrs) {
//        this(context, attrs, com.wefika.horizontalpicker.R.attr.horizontalPickerStyle);
//    }
//
//    public HorizontalPickerCustom(Context context, AttributeSet attrs, int defStyle) {
...
//                attrs,
//                com.wefika.horizontalpicker.R.styleable.HorizontalPicker,
//                defStyle, 0
//        );
//
//        CharSequence[] values;
...
//
//        try {
//            textColor = a.getColorStateList(com.wefika.horizontalpicker.R.styleable.HorizontalPicker_android_textColor);
//            if (textColor == null) {
//                textColor = ColorStateList.valueOf(0xFF000000);
//            }
//
//            values = a.getTextArray(com.wefika.horizontalpicker.R.styleable.HorizontalPicker_values);
//            ellipsize = a.getInt(com.wefika.horizontalpicker.R.styleable.HorizontalPicker_android_ellipsize, ellipsize);
//            marqueeRepeatLimit = a.getInt(com.wefika.horizontalpicker.R.styleable.HorizontalPicker_android_marqueeRepeatLimit, marqueeRepeatLimit);
//            dividerSize = a.getDimension(com.wefika.horizontalpicker.R.styleable.HorizontalPicker_dividerSize, dividerSize);
//            sideItems = a.getInt(com.wefika.horizontalpicker.R.styleable.HorizontalPicker_sideItems, sideItems);
//
//            float textSize = a.getDimension(com.wefika.horizontalpicker.R.styleable.HorizontalPicker_android_textSize, -1);
//            if(textSize > -1) {
...
//
//        touchHelper = new com.wefika.horizontalpicker.HorizontalPicker.PickerTouchHelper(this);
...
//    }
//
//    public void setOnItemSelectedListener(com.wefika.horizontalpicker.HorizontalPicker.OnItemSelected onItemSelected) {
//        this.onItemSelected = onItemSelected;
//    }
//
//    public void setOnItemClickedListener(com.wefika.horizontalpicker.HorizontalPicker.OnItemClicked onItemClicked) {
...
//
//        if (!(state instanceof com.wefika.horizontalpicker.HorizontalPicker.SavedState)) {
...
//                marquee = new com.wefika.horizontalpicker.HorizontalPicker.Marquee(this, layout, isRtl(values[item]));
...
//
//        private final WeakReference<HorizontalPickerCustom> mView;
...
//
//        Marquee(HorizontalPickerCustom v, Layout l, boolean rtl) {
...
//            }
//
//            mView = new WeakReference<com.wefika.horizontalpicker.HorizontalPicker>(v);
...
//
//            final com.wefika.horizontalpicker.HorizontalPicker view = mView.get();
...
//            mScroll = 0.0f;
//            final HorizontalPickerCustom view = mView.get();
...
//        public static final Parcelable.Creator<HorizontalPickerCustom.SavedState> CREATOR
...
//
//        private HorizontalPickerCustom mPicker;
//
//        public PickerTouchHelper(HorizontalPickerCustom picker) {
//            super(picker);
//            mPicker = picker;
//        }
//
